...
class IntroductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create introduction" do
    assert_difference('Introduction.count') do
      post introductions_url, params: { introduction: { scheduled_intro_date: @introduction.scheduled_intro_date } }
    end
  ...
  test "should update introduction" do
    patch introduction_url(@introduction), params: { introduction: { scheduled_intro_date: @introduction.scheduled_intro_date } }
